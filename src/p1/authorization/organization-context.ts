...
export function deriveOrganizationContext(resolved: ResolvedSyntheticMembership, requestId: string, actorType: SecurityContext['actorType']): SecurityContext {
...
export function deriveSyntheticOrganizationContext(resolved: ResolvedSyntheticMembership, requestId: string): SecurityContext {
  return deriveOrganizationContext(resolved, requestId, 'synthetic-user')
}

export function deriveAuthenticatedOrganizationContext(resolved: ResolvedSyntheticMembership, requestId: string): SecurityContext {
  return deriveOrganizationContext(resolved, requestId, 'authenticated-user')
}
